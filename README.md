...
- 課程影片：<https://www.youtube.com/watch?v=Kc14Un4SFS8>（Day2 影片製作中，尚未比照 Day1 內嵌播放器）
...
Day2 的首頁 RWD 驗證存放於 `_tooling/qa/`（`qa_day2_index_desktop.png`、`qa_day2_index_mobile.png`）。2026-07-18 完成資訊圖後，四篇文章各新增桌機與手機全頁截圖並保存在 `Day2/`：`qa_01_desktop_images.png`／`qa_01_mobile_images.png` 至 `qa_04_desktop_images.png`／`qa_04_mobile_images.png`，用來確認 16:9／9:16 圖片切換、文字可讀性與版面無溢出。
